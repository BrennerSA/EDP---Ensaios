                ...
                if self._inicio:
                    ...
                    if self.valoresEnsaio[0] > 0 : #só atualiza os pontos quando a leitura tiver sucesso
                        ...
                        if((self.timestamp-int(self.timestamp))==0 and self.timestamp != 0):
                            self._self.TopPanel.Y = savgol_filter(self._self.TopPanel.Y, 51, 8)
            ...
            if self.valoresEnsaio[0] > 1:
                ...
                if valoreS==0:
                    try:
                        ...
                        pressao_media=self._self.TopPanel.PressaoAtualGolpe
                        ...
                        modulo_instantaneo=(pressao_media*6.1752*1000/((abs(self.amplitudeMaxima-minimo))*self._self.altura))*(0.27+0.3)
                        ...
                        mr=(pressao_media*6.1752*1000/(abs((self.amplitudeMaxima-y_intersecao))*self._self.altura))*(0.2692 + 0.9976*0.3)
                        ...
                        modulo_total=(pressao_media*6.1752*1000/((abs(self.amplitudeMaxima-self.amplitudeMinima))*self._self.altura))*(0.27+0.3)
