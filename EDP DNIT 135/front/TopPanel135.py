        ...
        def INICIO(self, event):
            ...
            if self._self.bottom.Fase == 'CONDICIONAMENTO':
                ...
                if not self._self.bottom.condRT:
                    press=SetarPressoes.SetarPressaoGolpe(self._self.bottom.tens,0,float(self._self.bottom.DiametroMM.GetValue()))
                    self.PressaoAtualGolpe=self._self.bottom.tens
                time.sleep(0.5)
                dialog.Update(66)
                ...
                if self._self.bottom.Automatico == False:
                    condition = True
                    dlg3 = dialogoDinamico(3, "EDP DNIT135/2018ME", "MÓDULO DE RESILIÊNCIA", "Tudo pronto!", "Aperte INICIO.", "", None)
                    dlg3.ShowModal()
                    time.sleep(1)
